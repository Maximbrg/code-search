...
from sematch.sematch.semantic.sparql import EntityFeatures, StatSPARQL
from sematch.sematch.semantic.graph import GraphIC
from sematch.sematch.utility import FileIO, memoized
